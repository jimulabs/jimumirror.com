    ...
    <div class="comments-wrap">
        ...
        <div id="comments">
            ...
            <h3 id="comments-number"
                class="comments-header"><?php comments_number(__('No Comments', 'mo_theme'), __('<span class="number">1</span> Comment', 'mo_theme'), __('<span class="number">%</span> Comments', 'mo_theme')); ?></h3>
